...
const Home = () => {
  return (
    <div className="relative h-[500px] bg-black text-white flex items-center justify-center overflow-hidden">
      {/* Video Background */}
      ...
      <div className="relative container mx-auto flex flex-col md:flex-row items-center justify-center py-4">
        ...
        >
          <h1 className="text-2xl md:text-5xl font-bold text-green-400 mb-4">
            <Typing
