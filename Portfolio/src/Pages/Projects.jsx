      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:p-9'>
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/image copy 5.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
          ...
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/image copy 2.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
          ...
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/image copy.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
          ...
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/image.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
          ...
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/p1.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
          ...
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/image copy 4.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
          ...
          <div className='bg-gray-800 rounded-lg shadow-white shadow-sm overflow-hidden'>
            <img src='/src/assets/image copy 6.png' alt='Project' className='w-full h-60 object-cover' />
            <div className='p-6'>
